...
awful.keyboard.append_global_keybindings({
  ...
  awful.key({ ctrl }, "space", function() naughty.destroy_all_notifications() end,
    { description = "dismiss notification", group = "awesome" }),
  awful.key({ mod, ctrl }, "r", function() awful.spawn.with_shell("~/.local/scripts/record_screen.sh") end,
    { description = "record screen", group = "tool" }),
  ...
  awful.key({ mod }, "b", function() awful.spawn.with_shell("~/.local/scripts/randomBackground.sh") end,
    { description = "changes wallpaper", group = "tag" }),

  -- launch programms --

  awful.key({ mod }, "Return", function() awful.spawn("alacritty -e sh -c 'tmux attach || tmux new-session'") end,
    { description = "open terminal", group = "launch" }),
  awful.key({ mod, shift }, "Return", function() awful.spawn("alacritty") end,
    { description = "open terminal without tmux", group = "launch" }),
  awful.key({ mod, ctrl }, "o", function() awful.spawn.with_shell("~/.local/scripts/openphone.sh") end,
    { description = "phone", group = "launch" }),
  ...
  awful.key({ mod }, "d", function() awful.spawn.with_shell("~/.local/scripts/monitorhotplug") end,
    { description = "monitor hotplug", group = "tool" }),
  awful.key({ mod, ctrl }, "p", function() awful.spawn.with_shell("~/.local/scripts/colorpicker") end,
    { description = "colorpicker", group = "tool" }),
  awful.key({ mod, ctrl }, "q", function() awful.spawn.with_shell("~/.local/scripts/qr_codes") end,
    { description = "qr codes", group = "tool" }),

  -- screen control

  awful.key({ mod }, "[", function() _screen.focus_previous_screen_no_roll() end,
    { description = "focus previous screen", group = "awesome" }),
  awful.key({ mod }, "]", function() _screen.focus_next_screen_no_roll() end,
    { description = "focus next screen", group = "awesome" }),

  -- Help screen

  awful.key({ mod, shift }, "/", function() hotkeys_popup.show_help(nil, awful.screen.focused()) end,
    { description = "show help", group = "awesome" }),

  -- Mouse movements
  awful.key({ alt }, "h", function() awful.spawn("xdotool mousemove_relative -- -15 0") end,
    { description = "Move mouse left", group = "mouse" }),
  awful.key({ alt }, "j", function() awful.spawn("xdotool mousemove_relative -- 0 15") end,
    { description = "Move mouse down", group = "mouse" }),
  awful.key({ alt }, "k", function() awful.spawn("xdotool mousemove_relative -- 0 -15") end,
    { description = "Move mouse up", group = "mouse" }),
  awful.key({ alt }, "l", function() awful.spawn("xdotool mousemove_relative -- 15 0") end,
    { description = "Move mouse right", group = "mouse" }),
  awful.key({ alt }, "Return", function() awful.spawn("xdotool click 1") end,
    { description = "Left click mouse", group = "mouse" }),
  awful.key({ alt, shift }, "Return", function() awful.spawn("xdotool click 3") end,
    { description = "Right click mouse", group = "mouse" }),
  awful.key({ alt, shift }, "k", function() awful.spawn("xdotool click 4") end,
    { description = "Scroll mouse up", group = "mouse" }),
  awful.key({ alt, shift }, "j", function() awful.spawn("xdotool click 5") end,
    { description = "Scroll mouse down", group = "mouse" }),
  ...
  awful.key(
    ...
    { description = "notification center", group = "tag" }
  ),
  ...
  awful.key(
    ...
    { description = "calendar", group = "tag" }
  ),
  ...
  awful.key(
    ...
    { description = "profile control", group = "tag" }
  ),
  ...
  awful.key(
    ...
    { description = "hide bar", group = "tag" }
  ),
  ...
  awful.key(
    ...
    { description = "show tray", group = "tag" }
  ),
  ...
  awful.key({ mod }, "\\", function()
    ...
    { description = "KeepassXC autotype. It's actually /, but marking it properly leads to conflict", group = "launch" }),

  -- switching a focus client --

  awful.key({ mod }, "h", function() helpers.client.focus_direction("left") end,
    { description = "focus left", group = "client" }),
  awful.key({ mod }, "j", function() helpers.client.focus_direction("down") end,
    { description = "focus down", group = "client" }),
  awful.key({ mod }, "k", function() helpers.client.focus_direction("up") end,
    { description = "focus up", group = "client" }),
  awful.key({ mod }, "l", function() helpers.client.focus_direction("right") end,
    { description = "focus right", group = "client" }),
  awful.key({ mod }, "Tab", function() helpers.client.cycle_focus() end,
    { description = "focus next client in screen", group = "client" }),

  -- switch client to next screen
  awful.key({ mod, shift }, "]", function() _client.move_to_next_screen() end,
    { description = "Move to next screen", group = "client" }),

  awful.key({ mod, shift }, "[", function() _client.move_to_previous_screen() end,
