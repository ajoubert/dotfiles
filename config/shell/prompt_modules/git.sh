...
function set_git_branch() {
  ...
  GIT_BRANCH=${COLOR_PRIMARY}${GIT_BRANCH}${COLOR_NONE}
  USED_COLORS+="${COLOR_PRIMARY}${COLOR_NONE}"
}
...
function set_git_status() {
  ...
  then
    ...
    GIT_STATUS=${COLOR_ACCENT}${GIT_STATUS}${COLOR_NONE}
    USED_COLORS+=${COLOR_ACCENT}${COLOR_NONE}
  fi
}
