...
ANSIBLE_SUDO_PASS=$SUDOPASS ansible-playbook $PLAYBOOKS_HOME/upgrade_all.yml
ANSIBLE_SUDO_PASS=$SUDOPASS ansible-playbook $PLAYBOOKS_HOME/ovh/serv-0/deactivate_forwarding.yml
